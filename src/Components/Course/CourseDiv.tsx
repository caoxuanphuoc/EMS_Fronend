...
const Course = () => {
    return (
        <div className="CourseContainer flex gap-10 justify-center flex-wrap items-center m-5">
            <div className="group group/item singleJob w-[250px] p-[20px] bg-white rounded-[10px] 
            hover:bg-blueColor shadow-lg shadow-greyIsh-400/700 hover:sha-lg border border-solid border-gray-300    ">
                ...
                <button className="border-[2px] rounded-[10px] block p-[10px] w-full text-[14px] font-semibold text-textColor hover:bg-white group-hover/item:text-textColor group-hover:text-white mt-5">
                    Đăng ký
                </button>
            </div>
        </div>
